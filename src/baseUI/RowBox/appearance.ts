...
export const rowBoxStylePropNames: (keyof RowBoxAppearanceProps)[] = ['gapSize', 'noStratch']

// 样式的具体css-in-js实现
// BaseUI的样式：只提供能在黑白视图中，瞬间明白这玩意儿是干啥用的基础界面UI：
export const cssRowBoxAppearance = ({ gapSize = 'middle', noStratch }: RowBoxAppearanceProps) =>
  mix(
    { display: 'flex' },
    gapSize === 'small' && { gap: 4 },
